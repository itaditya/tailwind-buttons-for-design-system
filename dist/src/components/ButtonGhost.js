...
function ButtonGhost(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_ButtonBase["default"], _extends({}, restProps, {
    className: (0, _classnames["default"])("border-2 hover:text-white\n        disabled:text-black disabled:bg-transparent\n        active:text-white focus:text-white", mapGhostVariant[variant])
  }));
}

var _default = ButtonGhost;
exports["default"] = _default;

//# sourceMappingURL=ButtonGhost.js.map